...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        private final StarterPluginAccessors paccForStarterPluginAccessors = new StarterPluginAccessors(providers, config);
        ...
        /**
         * Group of plugins at <b>plugins.starter</b>
         */
        public StarterPluginAccessors getStarter() {
            return paccForStarterPluginAccessors;
        }
    ...
    public static class StarterPluginAccessors extends PluginFactory {
        private final StarterAndroidPluginAccessors paccForStarterAndroidPluginAccessors = new StarterAndroidPluginAccessors(providers, config);

        public StarterPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Group of plugins at <b>plugins.starter.android</b>
         */
        public StarterAndroidPluginAccessors getAndroid() {
            return paccForStarterAndroidPluginAccessors;
        }

    }

    public static class StarterAndroidPluginAccessors extends PluginFactory {
        private final StarterAndroidApplicationPluginAccessors paccForStarterAndroidApplicationPluginAccessors = new StarterAndroidApplicationPluginAccessors(providers, config);
        private final StarterAndroidLibraryPluginAccessors paccForStarterAndroidLibraryPluginAccessors = new StarterAndroidLibraryPluginAccessors(providers, config);

        public StarterAndroidPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Plugin provider for <b>starter.android.feature</b> with plugin id <b>starter.android.feature</b> and
         * with version <b>unspecified</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getFeature() { return createPlugin("starter.android.feature"); }

        /**
         * Plugin provider for <b>starter.android.hilt</b> with plugin id <b>starter.android.hilt</b> and
         * with version <b>unspecified</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getHilt() { return createPlugin("starter.android.hilt"); }

        /**
         * Group of plugins at <b>plugins.starter.android.application</b>
         */
        public StarterAndroidApplicationPluginAccessors getApplication() {
            return paccForStarterAndroidApplicationPluginAccessors;
        }

        /**
         * Group of plugins at <b>plugins.starter.android.library</b>
         */
        public StarterAndroidLibraryPluginAccessors getLibrary() {
            return paccForStarterAndroidLibraryPluginAccessors;
        }

    }

    public static class StarterAndroidApplicationPluginAccessors extends PluginFactory  implements PluginNotationSupplier{

        public StarterAndroidApplicationPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Plugin provider for <b>starter.android.application</b> with plugin id <b>starter.android.application</b> and
         * with version <b>unspecified</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> asProvider() { return createPlugin("starter.android.application"); }

        /**
         * Plugin provider for <b>starter.android.application.compose</b> with plugin id <b>starter.android.application.compose</b> and
         * with version <b>unspecified</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getCompose() { return createPlugin("starter.android.application.compose"); }

    }

    public static class StarterAndroidLibraryPluginAccessors extends PluginFactory  implements PluginNotationSupplier{

        public StarterAndroidLibraryPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Plugin provider for <b>starter.android.library</b> with plugin id <b>starter.android.library</b> and
         * with version <b>unspecified</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> asProvider() { return createPlugin("starter.android.library"); }

        /**
         * Plugin provider for <b>starter.android.library.compose</b> with plugin id <b>starter.android.library.compose</b> and
         * with version <b>unspecified</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getCompose() { return createPlugin("starter.android.library.compose"); }
