...
@NonNullApi
public class StarterProjectDependency extends DelegatingProjectDependency {

    @Inject
    public StarterProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
